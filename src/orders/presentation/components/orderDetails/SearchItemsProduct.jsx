  ...
  return (
    <div className="relative mb-4" ref={wrapperRef}>
      <input
        ...
        className="w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-[hsl(var(--ring))] focus:border-[hsl(var(--green))] bg-[hsl(var(--input))] text-[hsl(var(--foreground))] border-[hsl(var(--border))]"
        value={buscadorTerm}
      ...
      {filteredResults.length > 0 && (
        <ul
          role="listbox"
          className="absolute z-10 bg-[hsl(var(--background-unit))] border border-[hsl(var(--border))] rounded-lg shadow-md mt-2 w-full max-h-40 overflow-y-auto"
        >
