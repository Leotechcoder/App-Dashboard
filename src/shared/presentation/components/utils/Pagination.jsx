    ...
    <div className="px-6 py-3 flex items-center justify-between border-t scale-95">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="p-1 rounded border border-[hsl(var(--muted-foreground))] hover:cursor-pointer hover:border-[hsl(var(--foreground))] text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))] disabled:opacity-50"
        >
        ...
        {[...Array(totalPages)].map((_, index) => (
          <button
            ...
            className={`px-3 py-1 rounded ${
              currentPage === index + 1 ? "bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))]" : "border hover:bg-gray-50"
            }`}
          >
            {index + 1}
          </button>
