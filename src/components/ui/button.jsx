...
// Button variants actualizados para Tailwind 4
    ...
    "[&_svg]:pointer-events-none [&_svg]:w-4 [&_svg]:h-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-neutral-300 bg-background shadow-sm hover:bg-neutral-100 hover:cursor-pointer hover:border hover:border-neutral-900",
        secondary:
